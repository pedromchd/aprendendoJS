...
2. Houveram modificações da proposta? Quais? Justifique.
   Sim. Até o momento, a opção de mudar o tema do tabuleiro entre emojis, caracteres especiais, etc. não foi implementada, e não há um plano concreto para tal, havendo somente a presença de caracteres especiais. Além das 3 opções de tabuleiro /dificuldades foi ainda adicionada mais uma dificuldade "EXPERT". O jogador agora consegue jogar multiplayer e contra o computador.
...
3. Funcionalidades implementadas:
   ...
   - Mostrar o tabuleiro;
   - Definir o turno do jogador (multiplayer e versus computador);
   - Definir as jogadas possíveis dentro do tabuleiro (validação);
   - Escolher a figura no tabuleiro;
   - Mostrar o tabulrio;
   - Definir a chance do computador acertar um par;
   - Instruções para o computador escolher um par de peças;
   - Verificar se o par escolhido é verídico;
   - Verificar se todos os pares foram formados;
   - Definir a vitória do(s) jogadore(s);
   - A função para reunir todas as funcionalidades;
   - O código que irá rodar as funcionalidaes.

4. Funcionalidades faltantes:
   - Definir um método de saída no meio da partida (desistência);
   - Ocultar peças já combinadas no tabuleiro.

5. Qual percentual já implementado:
   89%.
*/
