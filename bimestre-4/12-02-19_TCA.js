...
function mainMenu() {
  do {
    ...
    if (men == 'R') {
      alert('No Jogo da memória, você deve encontrar pares de figuras escondidos em um tabuleiro de 4 dificuldades, forme todos e vença o jogo, utilizando de sua concentração e memória! \nUse de coordenandas para selecionar a figura a revelar! \nPressione ESC durante o jogo para desistir.');
    }
    if (men == 'C') {
