...
alert('Bem vindo ao jogo DESCUBRA A PALAVRA, nele, você escolhe a dificuldade de fácil à difícil, e depois o tamanho das palavras com que deseja jogar. Você deve inserir palavras do mesmo número de letras até descobrir a palavra escondida ou esgotar suas tentativas. A cada palavra inserida, o jogo mostra em qual tentativa você está, a palavra que você escolheu, e um número representando a quantidade de letras ERRADAS na palavra, se houver uma letra certa na posilçao certa esta será destacada em MAÍUSCULA. Palavras com acento e c-cedilha não são aceitas.');
do {
  do {
