...
if (PI == 'P','p' && (VC+PC)%2 == 0) alert('Você ganhou!');
if (PI == 'I','i' && (VC+PC)%2 == 0) alert('O computador ganhou!');
if (PI == 'P','p' && (VC+PC)%2 == 1) alert('O computador ganhou!');
if (PI == 'I','i' && (VC+PC)%2 == 1) alert('Você ganhou!');
